...
export default function SyndicateMembersPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Vet Members</h1>
        <p className="text-gray-600 mt-1">View all syndicate members across all branches</p>
      </div>
              ...
              {members.map((member) => (
                <tr key={member.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right">
                    <Link
                      href={`/syndicate/vet-members/${member.id}`}
