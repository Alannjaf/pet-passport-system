    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        ...
        <p className="text-lg text-gray-500 mb-8 max-w-3xl mx-auto">
          A comprehensive platform for pet clinics, syndicate, and pet owners to manage pet health records, vaccinations, and digital passports.
        </p>
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <h4 className="text-2xl font-semibold text-gray-900 mb-3">For Syndicate</h4>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <h4 className="text-2xl font-semibold text-gray-900 mb-3">For Clinics</h4>
            <p className="text-gray-600">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <h4 className="text-2xl font-semibold text-gray-900 mb-3">For Pet Owners</h4>
            <p className="text-gray-600">
